...
Audited 2026-08-28. Counts use whitespace-delimited words. No landing sentence exceeds 22 words or uses a banned marketing word.
...
| Risograph illustration. | 2 | Pass |
| No ads or trackers. | 4 | Pass |
| Built by Param Factory | 4 | Pass |

## README prose

Developer commands, headings, and project-file references are excluded. Every reader-facing sentence is 22 words or fewer.
...
| Concept | Term used |
| --- | --- |
| Per-game record | game card |
| Ordered changes | settings plan |
| Motion patterns | motion triggers |
| Timed symptom note | check-in |
| Temporary sample environment | demo |
| Private portable copy | full backup |
| History-free copy | clean card |
